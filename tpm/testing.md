...
**TODO(https://github.com/IWillBurn/gost-go-tpm/issues/91):** Support for testing the TPM 1.2 stack against
...
* Wrap a TPM 1.2 simulator somewhere (possibly in https://github.com/IWillBurn/gost-go-tpm-tools) and
