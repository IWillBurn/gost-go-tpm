...
const (
	...
	// [GOST] CHANGES START
	TPMAlgGOST3411256 TPMAlgID = 0x0100
	TPMAlgGOST3411512 TPMAlgID = 0x0101
	TPMAlgMagma       TPMAlgID = 0x0102
	TPMAlgGrasshopper TPMAlgID = 0x0103
	TPMAlgGOST3410256 TPMAlgID = 0x0104
	TPMAlgGOST3410512 TPMAlgID = 0x0105
	// CHANGES END
)
...
const (
	...
	// [GOST] CHANGES START
	// [GOST] TODO: FIX IT
	TPMECCCurveTC26Gost3410256ParamSetA TPMECCCurve = 0x0006
	TPMECCCurveTC26Gost3410256ParamSetB TPMECCCurve = 0x0007
	TPMECCCurveTC26Gost3410256ParamSetC TPMECCCurve = 0x0008
	TPMECCCurveTC26Gost3410256ParamSetD TPMECCCurve = 0x0009
	TPMECCCurveTC26Gost3410512ParamSetA TPMECCCurve = 0x000A
	TPMECCCurveTC26Gost3410512ParamSetB TPMECCCurve = 0x000B
	TPMECCCurveTC26Gost3410512ParamSetC TPMECCCurve = 0x000C
	// CHANGES END
)
